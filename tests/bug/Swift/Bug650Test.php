...
class Swift_Bug650Test extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(
            array('this is " a test öäü', 'this is =?utf-8?Q?=22?= a test =?utf-8?Q?=C3=B6=C3=A4=C3=BC?='),
            array(': this is a test öäü', '=?utf-8?Q?=3A?= this is a test =?utf-8?Q?=C3=B6=C3=A4=C3=BC?='),
        );
    }
}
